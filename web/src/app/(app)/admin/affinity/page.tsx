    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          ...
          аппараты. В ячейке — отношение к аппарату (5 уровней); на суточных
          постах отдельно сутки / день / ночь. «Вообще не ставить» — жёсткий
          запрет: солвер не поставит (кроме ручного фикса). Допуск к посту —
          галочкой; допуск к суткам/ночам задаётся уровнем «Вообще не ставить».
        </p>
      </div>
